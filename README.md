...
* [level09/enferno](https://github.com/level09/enferno) - A Python framework rooted in Flask comes pre-integrated with Vue3 and Vuetify3 for advanced UI design. It also provides ready-to-use user accounts and authentication modules, complemented by efficient caching and Redis capabilities, ensuring smooth development of robust applications
...
* [venaxyt/Instagram-Phishing](https://github.com/venaxyt/Instagram-Phishing) - HTML & CSS Instagram phishing page which send you victim's credentials through your Discord webhook
